...
function MenuDialog(props) {
  ...
  return (
    <div
      className="w-80 px-4 py-2 rounded border shadow-lg drop-shadow-md border-t-0 absolute z-50 bg-white"
      hidden={props.hidden}
      id={props.id}
    >
      <button
        ...
        hidden={props.groupIndex === todos.data.length - 1 ? true : false}
      >
        <svg
      ...
      <button
        className={
          props.groupIndex === 0 ? "" : "flex justify-start items-center"
        }
